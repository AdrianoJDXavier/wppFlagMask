...
<body>
    <form action="data2.php" method='POST'>
        <div class="phone-mask-container">
            <input type="text" name='tel1' class="rp_mask-wpp" placeholder="Digite o número de telefone" value="<?= $tel1 ?>">

            <input type="text" name='tel2' class="rp_mask-wpp" placeholder="Digite o número de telefone" value="<?= $tel2 ?>">
